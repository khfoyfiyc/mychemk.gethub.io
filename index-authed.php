...
<a class="num">+7 (952) 022 44 42 <br> (бесплатно по РФ)</a>
    ...
    <p class="login-text"><?php echo $user['name'] ?></p>
    <div class="logo">
...
<div class="mini-katalog">
    ...
    <a class="text-katalog">Чехлы на телефоны(223228)</a>
    <a class="text-katalog">Защитные стекла на телефоны</a>
    <a class="text-katalog">Наушники iphon air pods</a>
    <a class="text-katalog">Зарядники на телефоны</a>
</div>
<div class="korzina-button">
    <a class="korzina-money">5 800 <br> ₽</a>
    ...
    <a class="korzina-money">1 300 <br> ₽</a>
    <form action="korzina.html" class="for">
    <p><button class="btn">В корзину</button></p>
    </form>
    <a class="korzina-money">1 400 <br> ₽</a>
    <form action="korzina.html" class="for">
    <p><button class="btn">В корзину</button></p>
    </form>
</div>
...
<div class="podfooter01">
    <a class="podtext">Интернет-магазин аксессуаров для телефоны</a>
</div>
<div class="podfooter02">
    <a class="podtext2">Компания «Mobail» занимается продажей запчастей производителей. Мы поставляем только оригинальные запасные<br>
        части нашим клиентам. Также наша компания занимается ремонтом телефонов.<br>
        </a><br><a class="podtext2">Обращаясь в «Mobail», вы получаете:</a>
</div>
<div class="podfooter03">
    <a class="podtext03">возможность заказать оригинальные запчасти для Вашего телефона с доставкой по всей России любым удобным способом;<br>

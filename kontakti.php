...
<div class="gazz">
    <img class="gazz-img" src="img/баннер_ газель некст_ desk.jpg">
</div>
<div class="kontakti-text">
    <a class="txtkontakt">Контакты</a>
</div>
<div class="kontakti-text2">
    <a class="txtkontakt2">График работы</a>
    <a class="txtkontakt3">Контактная информация</a>
</div>
<div class="kontakti-text3">
    <a class="txtkontakt03">Понедельник - суббота: с 9:00 до 19:00 </a>
    <a href="#" class="txtkontakt04">+7 (952) 022 44 42 </a>
</div>

<div class="kontakti-text3">
    <a class="txtkontakt03">Воскресенье: с 9:00 до 18:00  </a>
    <a class="txtkontakt05"> (бесплатно по РФ) </a>
</div>
<div class="kontakti-text">
    <a class="txtkontakt">Реквизиты компании:</a>
</div>
<div class="kontakti-text3">
    <a class="txtkontakt03">Организация</a>
    <a class="txtkontakt06">ИП Мартынов Никита Сергеевич </a>
</div>
<div class="kontakti-text3">
    <a class="txtkontakt03">ИНН</a>
    <a class="txtkontakt07">7777777777777</a>
</div>
<div class="kontakti-text3">
    <a class="txtkontakt03">ОГРН/ОГРНИП</a>
    <a class="txtkontakt08">6666666666666</a>
</div>
<div class="kontakti-text3">
    <a class="txtkontakt03">Счёт</a>
    <a class="txtkontakt09">8888888888888888</a>
</div>
<div class="kontakti-text3">
    <a class="txtkontakt03">БИК</a>
    <a class="txtkontakt09">228228228228</a>
</div>
<div class="kontakti-text3">
    <a class="txtkontakt03">Наименование банка</a>
    <a class="txtkontakt10">ПАО Тинькофф</a>
</div>

...
<div class="container mlogin">
    <div id="login">
    <a class="txtlogin">Вход</a>

        <form action="src/actions/login.php" method="post">
        <p><label for="user_login">Email<br>
        <input class="input" name="email"size="20"
        type="text" value=""></label></p>
        <p><label for="user_pass">Пароль<br>
        <input class="input" type="password" id="password" name="password"size="20"
        type="password" value=""></label></p> 
            <p class="submit"><button class="button" type= "submit">Log In</button></p>

...
<a class="num">+7 (952) 022 44 42 <br> (бесплатно по РФ)</a>
    ...
    <div class="korz">
        <a href="#"><img src="img/корзина.png" class="korz-img"></a>
    </div>
...
<div class="gazz">
    <img class="gazz-img" src="img/okompanii.jpg">
</div>
<div class="okompaniitxt1">
    <a class="okompaniitext">О компании</a>
</div>
<div class="okompaniitxt2">
    <div class="wiidd">
    <div class="text">
    <a class="okompaniitext2">Компания «Mobile» является официальным дилером сети «Газ Детали машин» с 2007<br>
        года. Мы занимаемся продажей запчастей «группы ГАЗ», а также профессиональным<br>
        ремонтом автомобилей марки ГАЗЕЛЬ.<br>
            В нашем магазине представлен огромный ассортимент запасных частей — вы можете<br>
                выбрать все необходимое на месте или оформить заказ в интернет-магазине. В обоих<br>
                случаях наша дружная команда специалистов поможет вам сделать правильный выбор!
                <br>
                Обращаясь в «Mobile», вы получаете:</a>
                <br>
                <a class="okompaniitext3">возможность заказать оригинальные запчасти «Mobile» для Вашего<br>
                    автомобиля с доставкой по всей России любым удобным способом;<br>
                    уверенность в качестве товаров и услуг компании благодаря сертификатам<br>
                    качества;<br>
                    качественный и оперативный ремонт своего автомобиля с использованием<br>
                    оригинальных комплектующих.</a>
    </div>
    <div class="images">
        <img class="okompaniijpg" src="img/okompanii1.png">
    </div>
</div>
</div>
<div class="footer">
